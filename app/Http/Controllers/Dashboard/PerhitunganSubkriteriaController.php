...
class PerhitunganSubkriteriaController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.perhitungan_subkriteria.index', ['kriterias' => $kriterias]);
    }
    ...
    public function matrix(Request $request)
    {
        ...
        return view('dashboard.perhitungan_subkriteria.matrix', ['kriteria' => $kriteria, 'is_valid' => $is_valid], [
