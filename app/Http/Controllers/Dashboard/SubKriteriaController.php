...
class SubKriteriaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // return view('dashboard.subkriteria.index', compact('subkriterias', 'kriteria'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/kriteria/' . $request->id_kriteria)->with('success', 'Berhasil menambahkan subkriteria');
    }
    ...
    public function destroy(Request $request)
    {
        ...
        return redirect('/kriteria/' . $id_kriteria)->with('success', 'Berhasil menghapus subkriteria');
    }
}
