...
@section('content')
@section('title')Matrix Perbandingan {{ $kriteria->nama_kriteria }}@endsection

<div class="container-fluid">
    <div class="row mx-2" id="hasil_container">

        @php
        $hasInput = (count($kriteria->subkriterias) * count($kriteria->subkriterias)) ==
        count($perhitungans_all);
        @endphp
        ...
        <div class="card col-12 p-4">
            <form method="post" action="/perhitungan_subkriteria/store">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td class="border">
                                ...
                                <input type="text" name="{{$subkriteria2->nama_subkriteria . '[]'}}"
                                    value="{{number_format($subkriteria2->perhitungansubkriterias[$innerIndex]->nilai, 2)}}"
                                    class="form-control matrix_select" readonly>
                                @else
                                <select name="{{$subkriteria2->nama_subkriteria . '[]'}}"
                                    ...
                                    <option value="{{$subkriteria2->perhitungansubkriterias[$innerIndex]->nilai}}"
                                        data-dynamic="true">
                                        {{number_format($subkriteria2->perhitungansubkriterias[$innerIndex]->nilai,
                                        2)}}
                                    </option>
                ...
                <div class="col-12 text-end">
                    ...
                    <button type="submit" id="hitung_nilai_btn" class="btn btn-info"
        ...
        <div class="card col-12 p-4">
            <form method="post" action="/perhitungan_subkriteria/store">
                ...
                <table class="table border">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            @foreach ($kriteria->subkriterias as $innerIndex => $subkriteria3)
                            <td class="border">
                                @if ((count($kriteria->subkriterias) * count($kriteria->subkriterias)) !=
                                count($perhitungans_all))
                                <select name="{{$subkriteria2->nama_subkriteria . '[]'}}"
                                    class="form-select px-4 matrix_select" style="padding: 5px 20px"
                                    {{$innerIndex==$outerIndex ? 'disabled' : '' }}
                ...
                <div class="col-12 text-end">
                    <a href="/perhitungan_subkriteria" class="btn btn-warning">Kembali</a>
                    <button type="submit" class="btn btn-info">Hitung Nilai</button>
                </div>
            </form>
        </div>
        @endif
