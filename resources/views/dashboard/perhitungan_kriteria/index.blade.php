...
<div class="container-fluid px-4">
    ...
    <p class="alert alert-success text-white py-2 w-35" style="font-size: 12px">
        Nilai Consistensi Ratio dan Consistensi Index valid</p>
    @endif

    @if (($is_valid) && !$is_valid->is_valid)
    <p class="alert alert-danger text-white py-2 w-35" style="font-size: 12px">Nilai
        ...
        <div class="card col-12 p-4">
            ...
            <form method="post" action="/perhitungan/store">
                ...
                <div class="col-12 text-end">
                    <button type="submit" class="btn btn-info btn-hitung" style="display: none">
                        Hitung Nilai
                    </button>
                </div>
            </form>
    ...
    @include('dashboard.perhitungan_kriteria.hasilmatrix')

    @else
    @include('dashboard.perhitungan_kriteria.form')
    @endif
