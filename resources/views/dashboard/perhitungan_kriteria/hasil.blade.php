<div class="container-fluid py-2">
    ...
    <div class="card shadow p-2 w-35 bg-success text-white mx-1">Nilai Consistensi Ratio dan Consistensi Index valid
    </div>
    @endif

    @if (($is_valid) && !$is_valid->is_valid)
    <div class="card shadow p-2 w-55 bg-danger text-white mx-1">Nilai Consistensi Ratio dan Consistensi Index tidak
        valid,
        silahkan input kembali</div>
    @endif
    @endif

    <div class="row mx-1" id="hasil_container">
        <div class="card">
    ...
    <div class="row my-4 mx-1">
        <div class="card">
            <div class="col-md-12 p-4">
                <h4 class="mb-4">Hasil Nilai Matrix Kriteria</h4>
                @if (count($kriterias))
                <table class="table border">
                    <thead>
                        <tr class="text-center">
                ...
                <div class="col-12 my-2 w-70 mx-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <p class="p-0 m-0" style="color: #333">CR = {{number_format($ci/$nilai_index_random , 2)}}
                            </p>
                        </div>
                    </div>
                </div>
