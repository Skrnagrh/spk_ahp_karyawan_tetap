...
@section('content')
@section('title')Prangkingan Alternatif @endsection
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center mt-5">
            ...
            <a href="/perhitungan"><button class="btn btn-info mt-4 text-light" style="font-size: 14px"><i
        ...
        <div class="d-flex flex-column justify-content-center align-items-center mt-5">
            ...
            @if (Auth()->user()->admin == 'true')
            <a href="/perhitungan_subkriteria"><button class="btn btn-info mt-4 text-light" style="font-size: 14px"><i
                        class="bi bi-arrow-left"></i> Ke Hitung Subkriteria</button></a>
            @endif
        </div>
        @endif
    </div>
...
<div class="row my-4 mx-1 mb-5">
    <div class="card col-md-12 p-4">
        <h4 class="mb-4 text-center">Prangkingan Alternatif</h4>
...
@else
{{-- ini untuk alternatif yang masih kosong --}}
<div class="d-flex flex-column justify-content-center align-items-center mt-5">
    <img src="{{ asset('/dashboard/error-404.png') }}" alt="Empty Data" style="height: 300px" class="img-fluid">
    <div class="mt-3">
    ...
    @if (Auth::user()->admin == 'true')
    <a href="/perhitungan_subkriteria/alternatif"><button class="btn btn-info mt-4  text-light"><i
